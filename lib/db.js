...
/* The index on sales(customer_id) is NOT here on purpose. On a database that
   already exists, that column is added later by lib/loyalty.js — creating an
   index on it in the base schema runs before the column does and kills the
   process on boot. The index is created there, after the column. */
